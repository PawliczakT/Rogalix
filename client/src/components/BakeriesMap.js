...
const libraries = ['marker', 'places']; // Kolejność musi być identyczna wszędzie
...
const BakeriesMap = ({ year }) => {
  ...
  if (loadError) {
    ...
    return <Box textAlign="center" py={4}>Błąd ładowania API Google Maps: {loadError.message}. Sprawdź konsolę i konfigurację klucza API.</Box>;
  }
