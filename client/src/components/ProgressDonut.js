    ...
    return (
        <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center">
            <Box sx={{position: 'relative', display: 'inline-flex', mb: 1}}>
                <CircularProgress variant="determinate" value={percent} size={90} thickness={6}
                                  sx={{color: '#1976d2'}}/>
                <Box sx={{
                    top: 0,
                    left: 0,
            ...
            <Typography variant="subtitle1" color="text.secondary">Twój
                progres: {userVotes} / {totalRogals} ocen</Typography>
        </Box>
    );
};
