...
const AdvancedRogalCharts = () => {
  ...
  // Trend cen na przestrzeni lat (jeśli są dane o latach)
  // Można rozszerzyć jeśli backend zwraca rogal.year
  // const priceTrend = ...
  ...
  return (
    <Container>
      <Box sx={{ mt: 4 }}>
        ...
        {/* Można dodać więcej wykresów, np. trend cen po latach, rozkład wag, itp. */}
      </Box>
    </Container>
  );
};
