                ...
                <Card>
                    <CardContent>
                        ...
                        <Typography variant="body1">
                            Średnia
                            ocena: {rogal.averageRating !== undefined ? rogal.averageRating.toFixed(1) : 'No ratings yet'}
                        </Typography>
                        <Typography variant="body1">
                            Stosunek jakości do
                            ceny: {rogal.qualityToPriceRatio !== undefined ? rogal.qualityToPriceRatio.toFixed(2) : 'N/A'}
                        </Typography>
                        <Typography variant="body1">
                        ...
                        <Box sx={{mt: 4}}>
                            ...
                            {rogal.ratings && rogal.ratings.filter(r => r.comment && r.comment.trim() !== '').length > 0 ? (
                                ...
                                <Typography variant="body2" color="textSecondary">Brak komentarzy do tego
                                    rogala.</Typography>
                            )}
                        </Box>
